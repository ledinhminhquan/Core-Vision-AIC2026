...
python scripts/05_rebuild_map_keyframes.py --stride 5        # dhash + monotone DP — BẮT BUỘC vì thiếu map csv
...
- [ ] `pytest` **412 tests** xanh trên máy dev (CI cài torch-cpu để đủ bộ).
...
|---|---|---|
| Test suite | 412 pass (CI, torch-cpu) | `pytest` |

...
from cvf.models.base import EmbeddingModel


def _make_siglip2(settings: Settings) -> EmbeddingModel:
    from cvf.models.siglip2 import SigLIP2Model
...
def _make_openclip(settings: Settings) -> EmbeddingModel:
    from cvf.models.openclip_model import OpenClipModel

    return OpenClipModel(settings)


def _make_provided_clip32(settings: Settings) -> EmbeddingModel:
    from cvf.models.openclip_model import provided_clip32_model
...
def _make_mclip(settings: Settings) -> EmbeddingModel:
    from cvf.models.mclip_model import MClipModel

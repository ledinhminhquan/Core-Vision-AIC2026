...
``cvf.models.siglip2`` grafts at load time (``embedding.model: finetuned``).
...
from cvf.training.datamodule import TextImageEmbedDataset, collate
from cvf.training.losses import distill_cosine_loss, info_nce_loss, siglip_sigmoid_loss

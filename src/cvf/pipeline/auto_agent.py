...
def run_auto(
    ...
    *,
    ...
    """
    # Lazy heavy imports: keep `import cvf.pipeline.auto_agent` torch-free.
    from cvf.pipeline.run_queries import run_query_file
    ...
    if engine_factory is not None:
        ...
        from cvf.search.engine import SearchEngine  # heavy: numpy/faiss/pandas

...
(:func:`cvf.utils.text.tokenize_vi`) and persists the BM25 sufficient
statistics:
...
At query time :class:`cvf.search.text_signals.TextSignals` loads a field once
...
from cvf.utils.io import atomic_write_bytes, atomic_write_json, read_json
from cvf.utils.text import tokenize_vi
...
class TextIndexField:
    ...
    def scores_for(self, query_tokens: list[str], keys: list) -> dict:
        ...
        Mirrors ``cvf.search.text_signals._Bm25Field.scores_for``: the BM25Plus

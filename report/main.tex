...
dưới 1 giây/truy vấn; 530 test CPU + CI đảm bảo tính đúng của công thức chấm
...
Chất lượng kỹ thuật của mã được găm bằng 530 test CPU thuần (không cần GPU/mạng/data thật)

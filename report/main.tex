...
dưới 1 giây/truy vấn; 400 test CPU + CI đảm bảo tính đúng của công thức chấm
...
frame trong video \emph{gốc} lấy từ \texttt{map-keyframes}; với các bản data drop thiếu sạch
map-keyframes (thực tế dữ liệu chúng tôi tải về), công cụ
...
Chất lượng kỹ thuật của mã được găm bằng 400 test CPU thuần (không cần GPU/mạng/data thật)
